...
var JSLINT = (function () {
	...
	funct, functions, global, htmltag = {
		a: {},
		abbr: {},
		acronym: {},
		address: {},
	...
	ids, implied, inblock, indent, jsonmode, lines, lookahead, member, membersOnly, nexttoken, noreach, option, predefined, prereg, prevtoken, pseudorule = {
		'first-child': true,
		link: true,
		visited: true,
		hover: true,
...
(function() {
	...
	options = {
		...
		newcap: true, immed: true, indent: 3 
	};
    ...
    if (!JSLINT(script, options)) {
		...
		WScript.StdOut.WriteLine(JSLINT.report());
