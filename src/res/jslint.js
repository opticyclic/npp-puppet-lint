...
if(option.confusion){funct['(confusion)']=true;}
...
output.push('</div>');}}
return output.join('');};itself.jslint=itself;itself.edition='2011-12-21';return itself;}());